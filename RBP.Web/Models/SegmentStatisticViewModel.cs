...
namespace RBP.Web.Models
{
    public class SegmentStatisticViewModel : ClientBasedViewModel
    {
        ...
        public SegmentStatisticViewModel(string pageTitle, AccountReturnDto client, StatisticData statistic, IList<HandbookEntityReturnDto> allSegments, DateTime? start, DateTime? end) : base(pageTitle, client)
        {
            Statistic = statistic;
